...
import 'package:cloudfest_flutter_app/common/device_camera.dart';
...
class _CameraViewState extends State<CameraView>
        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              ...
              color:
                  controller?.value.flashMode == FlashMode.off ? Colors.orange : Colors.blue,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    ...
                    style: styleLocked,
                    onPressed:
                        controller != null ? () => controller!.setExposureOffset(0.0) : null,
                  ),
                ],
              ),
              const Center(
  ...
  Null onChangedLocal(CameraDescription? description) {
    if (description == null) {
      return;
    }
